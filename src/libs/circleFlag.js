...
class CircleScan {
    ...
    add(
        ...
        this.scanColor = Cesium.Color.fromCssColorString(scanColor)
    ...
    _addRadarScanPostStage(
        ...
        const _this = this
        this.ScanPostStage = new Cesium.PostProcessStage({
        ...
        this.viewer.entities.add({
            ...
            //     if(this.follow_entity.position.getValue(time)){
            //         let currentpos = this.Cartesian3ToWGS84(this.follow_entity.position.getValue(time))
            //         const cartographicCenter = new Cesium.Cartographic(
            //             Cesium.Math.toRadians(Number(currentpos.lon)),
            //             Cesium.Math.toRadians(Number(currentpos.lat)),
            //             Number(currentpos.alt)
            //         )
            //         this.viewer.scene.postProcessStages.remove(this.ScanPostStage)
            //         // this.ScanPostStage = this._addRadarScanPostStage(
            //         //     cartographicCenter,
            //         //     this.maxRadius,
            //         //     this.scanColor,
            //         //     this.duration
            //         // )
            //         // this.viewer.scene.postProcessStages.add(this.ScanPostStage)
            //         return this.follow_entity.position.getValue(time)
            //     }
            // }),
            ...
            ellipse: {
                ...
                material: new Cesium.ImageMaterialProperty({  //映射到图像 
                    image: this.ScanPostStage,
                    // transparent : true,
                    // color: this.scanColor
                }),
